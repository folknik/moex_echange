...
def get_price(driver, link):
    ...
    percent = driver.find_element_by_xpath("//*[@id='quotes_summary_current_data']/div[1]/div[2]/div[1]/span[4]").text.replace(',', '.')
...
if __name__ == '__main__':
    ...
    while True:
        try:
            ...
            message_list = ["{}: {} {}, {}".format(s[0], p[0], s[2], p[1]) for p, s in zip(stock_prices, stocks)]
            bot_sendtext("\n".join(message_list))
            sleep(60)
